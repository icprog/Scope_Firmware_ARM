...
#define UART0_CONFIG_PSEL_TXD 0 //TX pin
#define UART0_CONFIG_PSEL_RXD 1 //RX pin
#define UART0_CONFIG_PSEL_CTS 13 //Not used if HWFC is disabled
#define UART0_CONFIG_PSEL_RTS 14 //Not used if HWFC is disabled
